...
/// @DnDVersion : 1
/// @DnDHash : 092AD095
/// @DnDArgument : "code" "/// @description Creates instance bombs$(13_10)$(13_10)with(instance_create_depth(x-48, y, 0, obj_bomb)) {$(13_10)	image_xscale = other.image_xscale;$(13_10)	$(13_10)	movespeed = random_range(10, other.range_to);$(13_10)	jumpheight = -random_range(5, other.range_to);$(13_10)	$(13_10)	// Throw again$(13_10)	other.throw_bomb = true;$(13_10)}"
/// @description Creates instance bombs

with(instance_create_depth(x-48, y, 0, obj_bomb)) {
